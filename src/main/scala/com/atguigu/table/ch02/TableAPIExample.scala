package com.atguigu.table.ch02
...
object TableAPIExample {
  def main(args: Array[String]): Unit = {
    ...
    val blSettings = EnvironmentSettings.newInstance()
      ...
      .inStreamingMode()
      .build()
    val blTableEnv: StreamTableEnvironment = StreamTableEnvironment.create(env, blSettings)
    ...
    // 测试输出
    resultTable.toAppendStream[(String, Double)].print("simple result")
    // 聚合流不能使用toAppendStream
